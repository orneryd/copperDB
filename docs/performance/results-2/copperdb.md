...
**Run:** `2026-09-06T09:14:44.322099-07:00` → `2026-09-06T09:15:06.896691-07:00`
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| `products_per_category` | 0.19 | 0.18 | 0.20 | 0.21 | 0.17 | 0.21 | 0.01 | 4,756.90 |
| `customer_category_distinct_orders` | 0.13 | 0.13 | 0.16 | 0.16 | 0.12 | 0.17 | 0.01 | 7,197.27 |
| `optional_match_orders_count` | 0.19 | 0.19 | 0.20 | 0.20 | 0.17 | 0.21 | 0.01 | 4,778.21 |
| `revenue_by_product` | 0.13 | 0.12 | 0.14 | 0.15 | 0.12 | 0.15 | 0.01 | 7,660.63 |

- **Overall mean latency:** 0.16 ms
- **Overall throughput:** 11.80 ops/sec
- **Total benchmark wall-clock (sampled):** 25.700 s
...
- Avg CPU power: **8,541.7 mW**
- Avg GPU power: **19.2 mW**
- Avg package power: **8,560.9 mW**
- Estimated energy (benchmark window): **198.69 J**

## Memory Pressure

- Samples collected: **26** (~1s each)
- Avg used (active + wired + compressor): **20.0 GiB**
- Peak used: **20.3 GiB**
- Avg free: **862.6 MiB**
- Min free: **99.4 MiB**
...
- **Raw data files:** 156.0 MiB (163,606,528 bytes)
...
- Full data directory `du`: 182.8 MiB (191,635,456 bytes)
- Classified sum: 182.8 MiB (191,635,456 bytes, Δ vs du = +0 bytes)
