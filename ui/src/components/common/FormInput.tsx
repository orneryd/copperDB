...
export function FormInput({
  ...
  const inputClasses = `w-full ${
    Icon ? "pl-10" : "pl-4"
  } pr-4 py-2 bg-midnight-graphite border ${
    error ? "border-red-500/50" : "border-midnight-graphite"
  ...
  return (
    <div>
      ...
      <div className="relative">
        {Icon && (
          <Icon className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-silver-structural" />
        )}
        <input
          id={id}
          type={type}
