...
fn build_builtin_registry() -> ProcedureRegistry {
    ...
    let definitions = [
        ...
        (
            ...
            "db.create.setNodeVectorProperty(nodeId :: STRING, propertyKey :: STRING, vector :: LIST<FLOAT>)",
            "Sets vector property on a node",
            Write,
            B::SetNodeVectorProperty,
        ),
        (
            "db.create.setRelationshipVectorProperty",
            "db.create.setRelationshipVectorProperty(relationshipId :: STRING, propertyKey :: STRING, vector :: LIST<FLOAT>)",
            "Sets vector property on a relationship",
            Write,
            B::SetRelationshipVectorProperty,
        ),
        (
            "db.indexes",
